...
export default function RoomChat() {
    ...
    return (
        <Flex direction='column' width='500px' style={{
                    ...
                    messages && messages.map(message => (
                        ...
                        >
                            <Flex alignItems='center'>
                                ...
                                <Text marginLeft='2' color='#fff'>{message.text}</Text>
                            </Flex>
                        </Flex>
                    ))
                }
            ...
            <Flex style={{
                ...
                <Flex width='80%'>
                    <TextInput type="text" placeholder="type message" value={text} onChange={handleInputchange} />
                </Flex>
